...
save(fueling_station_sf, deli_sf, convenience_sf, grocery_sf, drug_store_sf, liquor_store_sf, check_cashing_sf, hair_beauty_sf, laundromat_sf, kindergarten_childcare_sf, auto_parts_sf, file = 'data/POI.rda')
